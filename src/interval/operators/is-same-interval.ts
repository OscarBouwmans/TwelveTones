...
/**
 * Returns `true` the two provided objects represent the same interval.
 * 
 * @example
...
/**
 * Returns `true` if all provided objects represent the same interval.
 * 
 * @example
 * isSameInterval(['P', '1'], ['P', '1'], ['P', '1']); // => true
 * isSameInterval(['P', '1'], ['P', '1'], ['P', '5']); // => false
 */
