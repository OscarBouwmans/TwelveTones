...
describe("Utilities", () => {
    describe("normalizedModulo", () => {
        it("Should Throw", () => {
            expect(() => { normalizedModulo(undefined as any, 0); }).toThrow();
            expect(() => { normalizedModulo(0, undefined as any); }).toThrow();
            expect(() => { normalizedModulo(null as any, 0); }).toThrow();
            expect(() => { normalizedModulo(0, null as any); }).toThrow();
            expect(() => { normalizedModulo("" as any, 0); }).toThrow();
            expect(() => { normalizedModulo(0, "" as any); }).toThrow();
            expect(() => { normalizedModulo({} as any, 0); }).toThrow();
            expect(() => { normalizedModulo(0, {} as any); }).toThrow();
            expect(() => { normalizedModulo([ 1 ] as any, 0); }).toThrow();
            expect(() => { normalizedModulo(0, [ 1 ] as any); }).toThrow();
            expect(() => { normalizedModulo("invalid" as any, "number" as any); }).toThrow();
            expect(() => { normalizedModulo(NaN, 0); }).toThrow();
            expect(() => { normalizedModulo(0, NaN); }).toThrow();
            expect(() => { normalizedModulo(NaN, NaN); }).toThrow();
        });
